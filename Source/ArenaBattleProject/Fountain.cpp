...
AFountain::AFountain()
{
	...
	Splash=CreateDefaultSubobject<UNiagaraComponent>(TEXT("SPLASH"));
	...
	static ConstructorHelpers::FObjectFinder<UNiagaraSystem>
		NS_SPLASH(TEXT("/Game/P_Buff_ShoutFreeze_02_Converted.P_Buff_ShoutFreeze_02_Converted"));

	if(NS_SPLASH.Succeeded())
	{
		Splash->SetAsset(NS_SPLASH.Object);
	}

	RotateSpeed=30.0f;
	Movement->RotationRate=FRotator(0.8f, RotateSpeed, 0.0f);
